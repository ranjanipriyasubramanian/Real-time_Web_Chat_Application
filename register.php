...
if(isset($_POST["register"]))
{
    ...
    else
    {
        if($user_object->save_data())
        {
            ...
            $mail->Username   = 'subramaniajith17@gmail.com';                     // SMTP username
            $mail->Password   = 'swsjmqgajqhfaeoa';

            $mail->SMTPSecure = 'tls';

            $mail->Port = 587;

            $mail->setFrom('subramaniajith17@gmail.com', 'web chat');
            ...
            <p>Thank you for registering for Chat Application .</p>
                ...
                <p><a href="http://localhost/chat/verify.php?code='.$user_object->getUserVerificationCode().'">Click to Verify</a></p>
                <p>Thank you...</p>
            ';
